...
const Login = () => {
  return (
    <div className='md:p-36 lg:px-96 pt-56 relative overflow-hidden bg-cover bg-no-repeat text-center shapes font-main text-white bg-[#26335D] h-screen'>
      <Nav/>
      <div class="container">
        <form class="bg-[#26335D] shadow-md text-center grid grid-cols-1 gap-5 w-full px-10 py-20 text-[#252B42] mx-auto rounded">
          ...
          <button class="border-white bg-[#8D5CF6] font-mediu border-[1.5px] text-white font-bold py-2 px-4 rounded block mx-auto w-full">Register</button>
        
          <div className='md:flex-col md:text-left md:gap-3 text-white'>
            <p>Already have an Account?</p>
            
            <div className='grid grid-cols-1 gap-1 mt-2 md:flex md:mt-0 md:gap-3'>
              <a href='/login' className='underline text-[#8D5CF6]'>Sign In here</a>
